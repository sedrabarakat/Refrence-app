                        ...
                        builder: (context)=>ElevatedButton(
                          onPressed: (){
                            if(key.currentState!.validate()){
                              cubit.get(context).sign_up_user(
                                ...
                                if((cubit.get(context).sign_user_token)!=null){
                                  cache_helper.saveData(key: 'token', value: cubit.get(context).sign_user_token);
                                  token=cubit.get(context).sign_user_token;
                                  print(token);
